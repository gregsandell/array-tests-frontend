# Credit Lock Web Components challenge
This is a programming challenge I took in April 2022 for
an interview I took with the Financial Services company https://array.com/.

See also:
1. README-greg-response.md for the comments I added to
my solution that I sent in.
2. The video I made demonstrating my solution: https://www.youtube.com/watch?v=uWUadD9SWas

Unfortunately the solution itself, `completedAssignment.html`, existed only within a Gitpod
walled garden that I wrote it in, which I no longer have access to.
The app was executed by right-clicking on `completedAssignment.html` and selecting 
_Open with Live Server_, a feature available only in Gitpod.

Everything below here is the original README that came with the challenge.
